...
class GeminiService:
    ...
    def generate_seo_article(theme: str, keywords: str = None) -> str:
        ...
        system_instruction = (
            "Eres un redactor experto en SEO y blogs profesionales. Tu tarea es generar un artículo de blog estructurado, informativo y de alta calidad.\n"
            "REQUISITOS IMPORTANTES:\n"
            "1. Devuelve EXCLUSIVAMENTE código HTML limpio para el cuerpo del post.\n"
            "2. NO uses bloques de código markdown (evita por completo encerrar la respuesta en ```html o ``` al inicio y final). Devuelve solo el texto HTML crudo.\n"
            "3. No incluyas las etiquetas <html>, <head>, <body> o <h1>. El título se gestiona por separado en WordPress.\n"
            "4. Usa únicamente las siguientes etiquetas HTML permitidas: <h2>, <h3>, <p>, <strong>, <ul>, <ol>, <li>, <blockquote>, <em>, <a>.\n"
            "5. El artículo debe estar redactado en español de forma fluida, atractiva y optimizado para SEO."
        )
